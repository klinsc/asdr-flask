...
# model related
max_epochs = 300
train_batch_size_per_gpu = 2  # 16/12 does not fit in 15GB, 8/6 does not fit for 1920x1920, 4 does not fit for 2240x2240
train_num_workers = 8  # 8/6 does not fit in 15GB, 4/3 does not fit for 1920x1920
